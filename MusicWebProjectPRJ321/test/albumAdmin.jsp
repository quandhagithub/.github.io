                ...
                <div class="home_inner">
                    ...
                    <div class="home_container">
                        <div class="home_content text-center">
                            <div class="home_subtitle">áº¢o hÃ³a thÃ nh áº£nh, Äáº£ kÃ­ch tÃ  gian</div>
                            <div class="home_title">Ninpuu Sentai Hurricanger</div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="multi-button">
                                    ...
                                    <s:a action="deletealbum">
                                        <s:param name="AlbumID"><s:property value="ID"/></s:param> 
                                            <button type="submit" id="someButton">Delete</button>
                                    </s:a>
                                </div>
                            </div>				
                        </s:iterator>
