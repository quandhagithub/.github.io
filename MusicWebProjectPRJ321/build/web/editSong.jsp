                ...
                <div class="home_inner">
                    ...
                    <div class="home_container">
                        <div class="home_content text-center">
                            ...
                            <div class="home_title">Edit Songs Page</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
                <div class="wrapper wrapper--w780">
                    <div class="card card-3">
                        ...
                        <div class="card-body">
                            <h2 class="title">Song Info</h2>
                            <form action="editsong" method="POST">
                                <input class="input--style-3" type="text" placeholder="ID" name="AlbumID" value="<s:property value="AlbumID"/>" hidden="true">
                                <div class="input-group">
                                    <input class="input--style-3" type="text" placeholder="ID" name="id" readonly="true" value="<s:property value="id"/>">
                                </div>
                                <div class="input-group">
                                    <input class="input--style-3" type="text" placeholder="Title" name="title" value="<s:property value="title"/>" pattern="[a-zA-Z0-9 ]+" title="Title only contains letters and number">
                                </div>
                                <div class="input-group">
                                    <input class="input--style-3" type="text" placeholder="Genre" name="genre" value="<s:property value="genre"/>" pattern="[a-zA-Z0-9 ]+" title="Genre only contains letters and number">
                                </div>


                                <div class="input-group">
                                <input class="input--style-3" type="text" placeholder="Path" name="path" value="<s:property value="path"/>" pattern="^(.*/)([^/]*)$" title="Path not valid">
                                </div>
